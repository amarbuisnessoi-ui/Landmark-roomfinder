...
import { Building2, Sparkles, SlidersHorizontal, CheckCircle2, MessageSquare, ShieldCheck } from 'lucide-react';
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
                ...
                {!currentUser && (
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-xs font-semibold transition-all cursor-pointer"
                  >
                    <span>Are you a property owner? Post a room &rarr;</span>
                  </button>
                )}
              </div>
              ...
              {rooms.length === 0 ? (
                <div className="text-center py-20 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-4">
                  ...
                  <h3 className="text-lg font-bold text-slate-800">No rooms match your search</h3>
                  <p className="text-xs text-slate-500 max-w-sm mx-auto">
                    Try adjusting your location query, price filter, or room type selection.
                  </p>
                  <button
                    onClick={handleResetFilters}
                    className="px-6 py-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold cursor-pointer shadow-sm"
                  >
