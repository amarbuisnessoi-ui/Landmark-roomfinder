                  ...
                  <div className="p-5 space-y-3 flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <p className="text-xs text-blue-600 font-semibold truncate">{room.location}, {room.city}</p>
                        {isRoomLocationExact(room) ? (
                          ...
                          <span className="inline-flex items-center gap-0.5 text-[10px] font-medium text-amber-700 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-200 shrink-0">
                    ...
                    <div className="pt-3 border-t border-slate-100 space-y-2">
                      ...
                      <div className="flex gap-2 pt-2">
                        <button
                          ...
                          className="flex-1 py-2 rounded-full bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold cursor-pointer border border-blue-200 flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-2 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold cursor-pointer"
                        >
                          View
                        </button>
                        <button
